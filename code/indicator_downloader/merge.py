...
def merge(quandl_api_key, GLASSNODE_API_KEY, AWS_ACCESS_KEY,AWS_SECRET_ACCESS, fullpath):
  ...
  bitmex2 = bitmexDownload2(fullpath,AWS_ACCESS_KEY,AWS_SECRET_ACCESS, write=True)
  print("DONE - BITMEX")
  #merge with bitmex
